...
const Modal = ({active, setActive, children, className, closable}) => {
    return (
        <AnimatePresence>
            {active &&
                <motion.div className={styles.overlay} initial={{ opacity: 0 }} exit={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }} onClick={closable ? e => setActive(false) : e => setActive(true)}>
